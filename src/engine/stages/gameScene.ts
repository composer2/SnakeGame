...
export class GameScene implements RenderableElement {
    ...
    private buildScene(sceneVisible: boolean) {
        ...
        for (var i = 0; i < this.numberOfBlocks; i++) {
            ...
            //Make a snake
            // if (i === 0) {
            //     snake = new PIXI.Sprite(this.id["snakeHead.png"]);
            // } else {
            // }
            ...
            //Add the snake to the `gameScene`
